                ...
                <div class="row">
                    <div class="left col-md-8">
                        ...
                        <form class="form" id="home_search" >
                            <div class="col-lg-6">
                                <div class="input-group" id="home_form">
                                    ...
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" id="button_search"><i class="icon-search"></i> <span class="caret"></span></button>
                            ...
                            <!--   <div class="input-group center" "home_form">
                                   <input class="input-lg" id="text_search" class="home_search" placeholder="Search here..."  type="text">
