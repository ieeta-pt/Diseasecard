                    ...
                    <div class="tab-content" style="overflow: hidden;">
                        ...
                        <h2>Overview</h2>
                            ...
                            <ul class="thumbnails">
                            	<li class="span6">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_search.png" />" alt="Home search" rel="tooltip" title="Searching in the homepage" />
                            			<div class="caption">
                            	...
                            	<li class="span6">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_search_disease.png" />" alt="Quick search" rel="tooltip" title="Searching everywhere with quicksearch" />
                            			<div class="caption">
                            ...
                            <ul class="thumbnails">
                            	<li class="span12">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_browse.png" />" alt="Browse" rel="tooltip" title="Browse all rare diseases" />
                            			<div class="caption">
                            ...
                            <ul class="thumbnails">
                            	<li class="span6">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_sidebar.png" />" alt="Sidebar" rel="tooltip" title="Sidebar navigation" />
                            			<div class="caption">
                            	...
                            	<li class="span6">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_hypertree.png" />" alt="Hypertree" rel="tooltip" title="Hypertree navigation" />
                            			<div class="caption">
                            	...
                            	<li class="span12">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_liveview.png" />" alt="LiveView" rel="tooltip" title="External resources within Diseasecard" />
                            			<div class="caption">
                            ...
                            <ul class="thumbnails">
                            	<li class="span6">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_linkeddata.png" />" alt="LinkedData" rel="tooltip" title="LinkedData interfaces" />
                            			<div class="caption">
                            	...
                            	<li class="span6">
                            		<div class="thumbnail">
                            			<img src="<c:url value="/final/assets/image/about/overview_sparql.png" />" alt="SPARQL" rel="tooltip" title="SPARQL endpoint" />
                            			<div class="caption">
