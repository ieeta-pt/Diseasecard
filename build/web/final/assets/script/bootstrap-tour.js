    ...
    (function($, window) {
        ...
        Tour = (function() {
            ...
            Tour.prototype.getState = function(key) {
                var value = $.cookie(this._options.name + "_" + key);     
                if(value === undefined) {
                    if(key === 'end') {
                        value = false;
                    } else {
            ...
            Tour.prototype._showPopover = function(step, i) {
                ...
                nav = [];
                if (step.prev >= 0) {
                    nav.push("<a href='#" + step.prev + "' class='prev btn btn-info btn-mini'>" + options.labels.prev + "</a>");
                }
                if (step.next >= 0) {
                    nav.push("<a href='#" + step.next + "' class='next btn btn-info btn-mini'>" + options.labels.next + "</a>");
                }
                content += nav.join(" ");
                content += "<a href='#' class='pull-right end btn btn-inverse btn-mini'>" + options.labels.end + "</a>";
