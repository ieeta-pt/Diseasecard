/**
 * JS handler for Diseasecard's browsing page. Loads all data from Diseasecard into datatables array: displays.
 *
 * @summary   JS browse handler.
 *
 * @since     4.5
...
function dtables(id) {
    $(id).dataTable({
        ...
        "bStateSave": true,
        "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-6'i><'col-md-6'pP>>",
        "oLanguage": {
        ...
        "fnInitComplete": function() {
            ...
            $('.dataTables_filter input').attr('placeholder', 'Filter').addClass('form-control').addClass('col-md-3').focus();
        }
    });
}
