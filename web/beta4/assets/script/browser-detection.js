...
var BrowserDetection = {
	...
	defaultNotSupportedBrowsers: [{'os': 'Any', 'browser': 'MSIE', 'version': 7}, {'os': 'Any', 'browser': 'Safari', 'version': 5}],
	noticeText: {
    	   'informal': { "title": "Hold on there!", "notice": "It appears you're using an outdated browser which prevents access to great Diseasecard features. Please <b>upgrade or install a new browser</b>!", "selectBrowser": "Visit the official sites for popular browsers below:", "remindMeLater": "Not now, but maybe later", "neverRemindAgain": "No, don't remind me again" }
    	  }
};
