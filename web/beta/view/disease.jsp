...
<s:layout-render name="/beta/layout/html.jsp">
    ...
    <s:layout-component name="custom_scripts">
        ...
        <script src="<c:url value="/beta/assets/script/jit.js" />"></script>
        <script src="<c:url value="/beta/assets/script/treeview.js" />"></script>
        <script src="<c:url value="/beta/assets/script/dc4.disease.js" />"></script>
    </s:layout-component>
