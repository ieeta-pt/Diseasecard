...
<s:layout-definition>
    ...
    <html>
        <head>
            ...
            <link rel="icon" type="image/ico" href="<c:url value="/beta/assets/image/dc4_icon.ico" />"></link> 
            <title><s:layout-component name="title">Diseasecard</s:layout-component></title>
            <s:layout-component name="style">
                <jsp:include page="/beta/layout/style.jsp" />
            </s:layout-component>
        </head>
        <body>
        ...
        <s:layout-component name="scripts">
            <jsp:include page="/beta/layout/script.jsp" />
        </s:layout-component>
