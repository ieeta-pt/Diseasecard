 ...
 * @author pedrolopes
 */
@UrlBinding("/legacy/{key}.{$event}")
public class LegacyEntryActionBean implements ActionBean {
    ...
    public Resolution html() {
        try {
            ...
            if (Config.isDebug()) {
                Logger.getLogger(LegacyEntryActionBean.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        try {
