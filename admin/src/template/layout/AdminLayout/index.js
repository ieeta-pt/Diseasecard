...
const mapDispatchToProps = dispatch => {
    return {
        onFullScreenExit: () => dispatch(full_screen_exit),
        onComponentWillMount: () => dispatch(collapse_menu)
    }
};
