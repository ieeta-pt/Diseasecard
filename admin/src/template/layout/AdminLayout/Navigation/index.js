...
import Aux from "../../../aux";
import {change_layout, collapse_menu} from "../../../templateSlice";
...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.template.preLayout,
        collapseMenu: state.template.collapseMenu,
        layoutType: state.template.layoutType,
        navBackColor: state.template.navBackColor,
        navBackImage: state.template.navBackImage,
        navIconColor: state.template.navIconColor,
        navBrandColor: state.template.navBrandColor,
        layout6Background: state.template.layout6Background,
        layout6BackSize: state.template.layout6BackSize,
        rtlLayout: state.template.rtlLayout,
        navFixedLayout: state.template.navFixedLayout,
        boxLayout: state.template.boxLayout,
        navDropdownIcon: state.template.navDropdownIcon,
        navListIcon: state.template.navListIcon,
        navActiveListColor: state.template.navActiveListColor,
        navListTitleColor: state.template.navListTitleColor,
        navListTitleHide: state.template.navListTitleHide
    }
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onChangeLayout: (layout) => dispatch(change_layout(layout)),
    }
};
