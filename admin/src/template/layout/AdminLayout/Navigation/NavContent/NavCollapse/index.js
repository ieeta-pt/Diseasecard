...
import Aux from "../../../../../aux";
import {collapse_toggle, nav_collapse_leave} from "../../../../../templateSlice";
...
const mapDispatchToProps = dispatch => {
    return {
        onCollapseToggle: (id, type) => dispatch(collapse_toggle({id: id, type: type})),
        onNavCollapseLeave: (id, type) => dispatch(nav_collapse_leave( {id: id, type: type}))
    }
};
