...
class MainCard extends Component {
    state = {
        ...
        fullCard: false,
        collapseCard: this.props.collapseCard,
        loadCard: false,
        cardRemove: false
    };
    ...
    render() {
        ...
        cardHeader = (
            <Card.Header onClick={ () => {this.setState( prevState => {return {collapseCard: !prevState.collapseCard}})}}>
        ...
        if (this.state.cardRemove) {
            cardClass = [...cardClass, 'dashboard-none'];
        }
